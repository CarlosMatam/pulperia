...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  void initState() {
    ...
    _model.textNombreProductoController ??= TextEditingController();
  }
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: TextFormField(
                  controller: _model.textNombreProductoController,
                  autofocus: true,
                  obscureText: false,
                  ...
                  validator: _model.textNombreProductoControllerValidator
                      .asValidator(context),
                ),
              ),
              Padding(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        final productoCreateData = createProductoRecordData(
                          nombre: _model.textNombreProductoController.text,
                        );
